    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='https://direncuyanik.com' class='snake-link'>Direnc Uyanik</a>  - <a href='https://www.youtube.com/channel/UCZVhyrhI4viDRYeh72Jg7mg/' class='snake-link'>Youtube Kanalım</a>";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "Tam ekran moduna geçmek için F11 tuşuna veya yukardaki tam ekran butonuna basabilirsiniz.";
            }
            welcomeTxt.innerHTML = "Yılan Oyunu <p></p> Oyunu oynamak için klavyenizdeki <strong>ok tuşlarını </strong>kullanın. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Oyuna Başla"));
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Yılan Oyunu<p></p>" + message + "<p></p>";
            var gameEndStart = document.createElement("button");
            gameEndStart.appendChild(document.createTextNode("Yeniden oynamak ister misin?"));
        ...
        function createTryAgainElement() {
            return createGameEndElement("Kaybettin :(", "sbTryAgain", "snake-try-again-dialog");
        }

        function createWinElement() {
            return createGameEndElement("Kazandın! :D", "sbWin", "snake-win-dialog");
        }
        ...
        */
        me.resetBoard = function() {
            ...
            mySnake.reset();
            elmLengthPanel.innerHTML = "Uzunluk: 1";
        ...
        */
        me.foodEaten = function() {
            ...
            if (mySnake.snakeLength > localStorage.jsSnakeHighScore)
            {
                ...
                elmHighscorePanel.innerHTML = "En Yüksek Skor: " + localStorage.jsSnakeHighScore;
            }
